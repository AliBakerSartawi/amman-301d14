...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: because the variable rando was declared in a different scope (child scope - line 33) and is not accessible in line 38 (parent scope). But, it would have worked if the scopes were reversed; in line 35 it works fine, for example.
  console.log(viewed);
